...
wrist_aim_tolerance: radians = 4 * degrees_to_radians
feed_motor_id = 3
...
drivetrain_aim_tolerance: radians = 3 * degrees_to_radians
...
WRIST_CONFIG = SparkMaxConfig(.25, 0, 0.003, 0, (-.6, .6), idle_mode=rev.CANSparkMax.IdleMode.kBrake)
