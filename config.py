...
elevator_feed_forward: float = 0.4 / 12
...
v0_flywheel_maximum: meters_per_second = 25
...
ELEVATOR_CONFIG = SparkMaxConfig( # -.65, 1
    0.25, 0.0, 0.04, elevator_feed_forward, (-.75, 1), idle_mode=rev.CANSparkMax.IdleMode.kBrake
)
