...
#     assert flywheel.get_velocity_linear(1) ==
#     flywheel.rpm_to_angular_velocity(test_input) * constants.flywheel_radius_outer
#
...
#     assert flywheel.get_velocity_linear(2) ==
#     flywheel.rpm_to_angular_velocity(test_input) * constants.flywheel_radius_outer
#
#     assert flywheel.get_velocity() ==
#     (flywheel.rpm_to_angular_velocity(test_input), flywheel.rpm_to_angular_velocity(test_input))
#
# @pytest.mark.parametrize(
#     "test_input",
#     [
