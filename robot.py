...
class _Robot(wpilib.TimedRobot):
    ...
    def robotPeriodic(self):
        ...
        # self.handle(self.scheduler.onCommandInitialize(lambda command: self.log.info(f"Initializing command {command.getName()}")))
        # self.handle(self.scheduler.onCommandFinish(lambda command: self.log.info(f"Finishing command {command.getName()}")))
        # self.handle(self.scheduler.onCommandInterrupt(lambda command: self.log.info(f"Interrupting command {command.getName()}")))
